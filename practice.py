class Bank:
    def __init__(self, total_amount, limit_for_loan, limit_for_withdrawal):
        ...
        self.limit_for_loan = limit
        self.limit_for_withdrawal = limit_for_withdrawal

    def repeat_withdrawal_money(self, amount, limit_for_loan, limit_for_withdrawal):
    ...
    def show_me_the_money(self, amount):
       ...
       if amount <= self.total_amount:
          self.repeat_withdrawal_money(amount, self.limit_for_withdrawal)
